...
export const projects = [
  { key: "epub", label: "Epub" },
  { key: "pr", label: "PR" },
  { key: "milltown_opendoc", label: "Milltown/Opendoc" },
  { key: "tetra", label: "Tetra" },
  { key: "absent_voters", label: "Absent Voters Lists" },
  { key: "harleian", label: "Harleian Society" },
  { key: "belgium_vitals", label: "Belgium Vitals" },
  { key: "russian_documents", label: "Russian Documents" },
  { key: "honduras_1", label: "Honduras Part 1" },
  { key: "indian_census", label: "United States, Indian Census Rolls, 1885-1940" },
  { key: "latvia_german", label: "Latvia German" },
